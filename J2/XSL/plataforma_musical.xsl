...
<body>
  ...
  <!-- Ejercicio 3: Tabla usuarios -->
  <h2>Usuarios</h2>
  <table>
    <tr>
      <th>Nombre Usuario</th>
      <th>Plan</th>
      <th>Numero de Generos Favoritos</th>
    </tr>
    <xsl:for-each select="streaming/usuarios/usuario">
      ...
      <tr>
        <td>
          ...
          <xsl:if test="plan = 'Premium'"> (*)</xsl:if>
        </td>
